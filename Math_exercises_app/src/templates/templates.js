define(['handlebars'], function (Handlebars){Handlebars = Handlebars['default']; var templates = Handlebars.templates || {};  templates["exercise"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "   <div class=\"expression-container\">\n       <span class=\"expression-body\">"
    ...
    + "\"/>\n       <button class=\"validate-answer\">Validate</button>\n       <span class=\"answer-icon\">\n         <span class=\"correct-icon\">Pass!</span>\n         <span class=\"incorrect-icon\">Fail</span>\n       </span>\n       <span class=\"attempts-status\">\n         <span class=\"attempts-counter hidden\">\n            Attempts left: "
    ...
    + "\n         </span>\n         <span class=\"attempts-icon\">\n           <span class=\"attempt-incorrect\">\n             Incorrect\n           </span>\n         </span>\n       </span>\n   </div>";
},"useData":true});
...
templates["exerciseStartScreen"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "";
},"useData":true});
